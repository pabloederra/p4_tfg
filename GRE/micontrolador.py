...
global_data['index'] = 0
global_data["mac_tun1"] = "08:00:00:00:03:33"
global_data["mac_tun2"] = "08:00:00:00:04:44"
...
def tunnel_rules(sw, srcMac, dstMac, srcIp, dstIp):
    """
    ...
    table_entry2 = global_data['p4info_helper'].buildTableEntry(
        ...
        match_fields={
            "standard_metadata.egress_port" : 2 #no hay que poner string
        },
...
async def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        tunnel_rules(s1, global_data["mac_tun1"], global_data["mac_tun2"], global_data["ip_tun1"], global_data["ip_tun2"])
        tunnel_rules(s2, global_data["mac_tun2"], global_data["mac_tun1"], global_data["ip_tun2"], global_data["ip_tun1"])
